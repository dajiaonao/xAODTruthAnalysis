...
# Stop Polarization
python make_plots.py -i "Herwigpp_300vs180,Madgraph_300vs180,MadgraphR_300vs180,MadgraphL_300vs180" -v "${var}" -r "VR_STOP_INC" -f "eps" -l 10000 -L -b -a;
...
#python make_plots.py -i "Sherpa_lvlv,Sherpa_lvlv_fac4,Sherpa_lvlv_fac025,Sherpa_lvlv_renorm4,Sherpa_lvlv_renorm025,Sherpa_lvlv_qsf4,Sherpa_lvlv_qsf025" -v "mT2ll" -r "SR_SF_NOMT2,SR_DF_NOMT2" -f "eps" -L -b -a;
